...
document.getElementById('user-easy-mode').addEventListener('click', function() {
    window.location.href = 'http://127.0.0.1:5500/Tic_Tac_Toe/mode_change/user_mode/easy_mode/index.html';
});

document.getElementById('user-hard-mode').addEventListener('click', function() {
    window.location.href = 'http://127.0.0.1:5500/Tic_Tac_Toe/mode_change/user_mode/hard_mode/index.html';
});

// Redirect to appropriate User vs Computer mode
document.getElementById('computer-easy-mode').addEventListener('click', function() {
    window.location.href = 'http://127.0.0.1:5500/Tic_Tac_Toe/mode_change/computer_mode/easy_mode/index.html';
});

document.getElementById('computer-hard-mode').addEventListener('click', function() {
    window.location.href = 'http://127.0.0.1:5500/Tic_Tac_Toe/mode_change/computer_mode/hard_mode/index.html';
});
